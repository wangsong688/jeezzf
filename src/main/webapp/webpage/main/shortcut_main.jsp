...
<tr>
    ...
    <!--
        ...
        <div style="position: absolute; top: 75px; left: 33px;">JEEZZF Framework <span style="letter-spacing: -1px;"> <t:mutiLang langKey="system.version.number"/></span></div>
    </td>
...
<div region="south" border="false" style="height: 25px; overflow: hidden;">
    <div align="center" style="color: #1fa3e5; padding-top: 2px">&copy;
        ...
        <span class="tip">
            <a href="http://www.bjzzf.org" title="JEEZZF Framework  <t:mutiLang langKey="system.version.number"/>">JEEZZF Framework  <t:mutiLang langKey="system.version.number"/></a>
