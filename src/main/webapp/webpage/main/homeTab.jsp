...
<div style="display: none">
	<div id="p1" title="JEEZZF简介" collapsible="true">
		<div title="JEEZZF简介" collapsible="true" closable="flase" style="height:350px;" >
					<div style="margin-top: 14px;">
					<h3>简介</h3>
					<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;JEEZZF（J2EE Code Generation）是一款基于代码生成器的智能快速开发平台，引领新开发模式(智能开发\在线开发\插件开发)， 可以帮助解决Java项目80%的重复工作，让开发更多关注业务逻辑。既能快速提高开发效率，帮助公司节省人力成本，同时又不失灵活性。 <br>
					&nbsp;&nbsp;&nbsp;&nbsp;JEEZZF快速开发宗旨是：简单功能由代码生成器生成使用; 复杂业务采用表单自定义，业务流程使用工作流来实现、扩展出任务接口，供开发编写业务逻辑。 实现了流程任务节点和任务接口的灵活配置，既保证了公司流程的保密性，又减少了开发人员的工作量</p>
					<h3>架构说明</h3>
					<ul>
						<li>JEEZZF开发平台采用SpringMVC+MiniDao+UI快速开发库+ OnlineCoding开发组件 的基础架构,采用面向声明的开发模式， 基于泛型编写极少代码即可实现复杂的数据展示、数据编辑、<br>
						表单处理等功能，再配合代码生成器的使用,将J2EE的开发效率提高6倍以上，可以将代码减少60%以上。</li>
						<li>JEEZZF_<font color="red">v3.6 </font>最新版十二大技术点: <b>1.代码生成器</b> <b>2.用户权限</b> <b>3.Online在线开发</b> <b>简易Excel导入导出</b> <b>5.查询过滤器</b> <b>6.UI标签库</b> <b>7.国际化</b> <b>8.多数据源</b> <b>9.自定义表单</b> <b>10.在线报表配置</b> <b>11.系统日志监控</b> <b>12.首页风格切换</b></li>
