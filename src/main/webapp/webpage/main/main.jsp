...
<!-- 顶部-->
<div region="north" border="false" title=" JEEZZF Framework  <t:mutiLang langKey="system.version.number"/>" style="BACKGROUND: #E6E6FA; height: 85px; padding: 1px; overflow: hidden;">
...
<div region="south" border="false" style="height: 25px; overflow: hidden;">
    <div align="center" style="color: #CC99FF; padding-top: 2px">&copy;
        ...
        <span class="tip">
            <a href="http://www.jeecg.org" title=" JEEZZF Framework  <t:mutiLang langKey="system.version.number"/>"> JEEZZF Framework  <t:mutiLang langKey="system.version.number"/></a>
            <t:mutiLang langKey="common.copyright"/>:
            <a href="#" title=" JEEZZF Framework  <t:mutiLang langKey="system.version.number"/>">JEEZZF Framework  <t:mutiLang langKey="system.version.number"/></a>
        </span>
    </div>
</div>
