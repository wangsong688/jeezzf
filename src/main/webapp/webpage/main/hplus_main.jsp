...
<head>
    ...
    <link href="plug-in/ace/assets/css/font-awesome.min.css" />
    <!--[if IE 7]>
...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
                ...
                <div class="navbar-header" style="height: 60px;"><a class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="#"><i class="fa fa-bars"></i> </a>
                    <form role="search" class="navbar-form-custom" method="post" action="search_results.html">
                        <div class="form-group">
                            <input type="text" placeholder="欢迎使用智能快速开发平台 …" class="form-control" name="top-search" id="top-search">
                        </div>
                    </form>
                </div>
        ...
        <div class="footer">
            <div class="pull-right">&copy; <t:mutiLang langKey="system.version.number"/> <a href="http://www.bjzzf.org/" target="_blank">jeezzf</a>
            </div>
        </div>
    </div>
    <!--右侧部分结束-->
...
<!-- 在线聊天 -->
<%-- <%@include file="/context/layui.jsp"%> 暂时注释掉 --%>
<script>
    function logout(){
