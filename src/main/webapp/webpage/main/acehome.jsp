...
<body class="gray-bg">
    <div class="row  border-bottom white-bg dashboard-header">
        <div class="col-sm-12">
            <blockquote class="text-warning" style="font-size:14px">您是否需要一款企业级智能开发平台，提高开发效率，缩短项目周期…
        ...
        <div class="col-sm-5">
            ...
            <p>JEEZZF是一款基于代码生成器的智能开发平台，开源界“小普元”超越传统商业企业级开发平台。引领新的开发模式(Online Coding模式(自定义表单)->代码生成器模式->手工MERGE智能开发)， 可以帮助解决Java项目60%的重复工作，让开发更多关注业务逻辑。既能快速提高开发效率，帮助公司节省人力成本，同时又不失灵活性。她可以用于所有的Web应用程序，如:<b>MIS</b>，<b>CRM</b>，<b>OA</b>，<b>ERP</b>，<b>CMS</b>，<b>网站后台</b>，<b>微信管家</b>，等等，当然，您也可以对她进行深度定制，以做出更强系统。</p>
            <p>
                <b>当前版本：</b>v1.0.1
            </p>
            <p>
            ...
            <br>
            <p>
                <a class="btn btn-success btn-outline" href="http://www.bjzzf.org/" target="_blank">
                    <i class="fa fa-qq"> </i> 联系我们
                </a>
                <a class="btn btn-white btn-bitbucket" href="http://www.bjzzf.org/" target="_blank">
        ...
        <div class="row">
            <div class="col-sm-4">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <p><i class="fa fa-send-o"></i> 官网：<a href="http://www.bjzzf.org" target="_blank">http://www.bjzzf.org</a>
                        </p>
                            ...
                            <div class="panel-group" id="version">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div id="v33" class="panel-collapse collapse">
                                        <div class="panel-body">
                                            <ol>
                                                <li>更多版本，请详见论坛：www.bjzzf.org</li>
                                            </ol>
                                        </div>
                                    </div>
                                </div>
