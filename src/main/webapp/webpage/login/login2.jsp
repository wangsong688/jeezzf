...
<div align="center" class="container loginBg">
    ...
    <div class="login">
    	<ul class="titleName">
        	<li class="english">JEEZZF|BPMN</li>
    ...
    <div class="copyright ">
    	<span>&copy; 北京智征峰科技有限公司版权所有 <span class="tip"><a href="#" title=智能演示系统>jeezzf</a> (推荐使用IE8+,谷歌浏览器) 技术支持：:<a href="#" title=智能 演示系统>jeezzf</a></span></span>
    </div>       
</div>
</form>
