...
<head>
  ...
  <title><t:mutiLang langKey="jeect.platform"/></title>
   <link rel="shortcut icon" href="images/jeezzf.ico">
      ...
      <div class="col-sm-10 col-sm-offset-1">
        <div class="login-container">
          <div class="center">
            ...
            <h4 class="blue" id="id-company-text">www.bjzzf.org</h4>
          </div>
          ...
          <div class="position-relative">
            ...
            <div class="center"><h4 class="blue" id="id-company-text">&copy; 北京智征峰科技有限公司</h4></div>
